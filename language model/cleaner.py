...
def main():
    ...
    objects = []
    lines = open(args.corpus_path, mode='r', encoding='utf-8').readlines()
    ...
    for line in tqdm(lines, desc='applying cleaning jobs:'):
        ...
        obj = process_line(line, args.min_words)
        objects.append(obj)
    with open(args.corpus_clean, mode='w', encoding='utf-8') as file:
