...
def main():
    wiki_dump_file_in = Path('fawiki-latest-pages-articles.txt')
    wiki_dump_file_out = wiki_dump_file_in.parent / f'{wiki_dump_file_in.stem}_preprocessed{wiki_dump_file_in.suffix}'
